...
export default class Login extends Component {
  ...
  CreateButton = () => {
    if (this.state.username === "" || this.state.email === "") {
      this.setState({
        isOpenSnack: true,
        SnackbarMessage: "Ooops! You have missed Username or Email",
      });
    } else {
      ...
      this.setState({
        isOpenSnack: true,
        SnackbarMessage: "Account has been created!",
      });
    }
  };
                    ...
                    <div>
                      ...
                      <div className="text-center mt-4">
                        <Button
                          variant="outlined"
                          color="primary"
                          style={{ color: "#f66962", borderColor: "#f66962" }}
                        >
                      ...
                      <div className="mt-5">
                        <p>
                          ...
                          <span
                            className="txt-f66962 cursor-pointer"
                            onClick={() => this.SingUpButton()}
                          >
                            Sign Up
                          </span>
                        </p>
                ...
                {this.state.isSignUp ? (
                  <>
                    <div>
                      ...
                      <p>Start Learning Anything You Love from Anywhere!</p>
                      ...
                      <div className="text-center mt-4">
                        <Button
                          ...
                          style={{ color: "#f66962", borderColor: "#f66962" }}
                        >
                          <i className="fab fa-google"></i> &nbsp; Sign With
                          Google
                        </Button>
                      </div>
