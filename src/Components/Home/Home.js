        ...
        return(
            ...
            <div className="bg-light p-3">
                ...
                <div className="mt-2">
                    ...
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Distinctio alias recusandae asperiores in deserunt,
                </div>
            </div>
            </div>
        )
        ...
        return (
            <>
                        ...
                        <div className="row  align-items-center justify-content-center">
                            <div className="col-lg-6 mb-5">
                                ...
                                <p className="txt-777578">
                                    Choose from over 100,000 online videos courses with new additions published every months.
                                </p>
                                <div className="d-flex">
                                    <button className="btn  button-primary mx-3">Contact Me!</button>
                ...
                <div className="container py-5">
                    <div className="row">
                        <div className="col-lg-6">
                            <h3>Know about learning <br /> learning platforms</h3>
                            <p>
                                With our growing catalog of over 30 Nanodegree programs from beginner to advanced your're sure to find one that fits your career goals.
                            </p>
                            <ul className="list-unstyled">
                                <li><i class="fas fa-check-double txt-67c97d mt-2"></i> &nbsp; Free E-book , video &amp; Consolations</li>
                                <li><i class="fas fa-check-double txt-67c97d mt-2"></i> &nbsp; Top instructors from around world</li>
                                <li><i class="fas fa-check-double txt-67c97d mt-2"></i> &nbsp; Top coursed fro your team.</li>
                            </ul>
